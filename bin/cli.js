...
const { generateNodeJs, generateNestJs, generatePython } = require('../src/generators');

async function main() {
  console.log(chalk.greenBright.bold('\n✨ Welcome to Cartridge SDK! ✨\n'));
  console.log(chalk.gray('Cartridge helps you set up user authentication CRUD operations for your preferred backend framework.\n'));
  ...
  try {
    ...
    const selectedGenerator = generators.find(gen => gen.value === framework);
    ...
    const spinnerInterval = setInterval(() => {
      process.stdout.write(`\r${chalk.cyan(spinnerChars[spinnerIndex])} Generating files...`);
    ...
    console.log(chalk.gray('Your user authentication CRUD operations have been set up!\n'));
    ...
    if (framework === 'python') {
      ...
      console.log(chalk.yellow.bold('📦 Next steps:\n'));
      console.log(chalk.white('1. Install dependencies using your preferred package manager:'));
    ...
    console.log(chalk.gray(`Files have been generated in: ${chalk.white(currentDir)}\n`));
  } catch (error) {
